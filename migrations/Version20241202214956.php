 ...
 */
final class Version20241202214956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id UUID NOT NULL, status_id INT NOT NULL, topic VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
